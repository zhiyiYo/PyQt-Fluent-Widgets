...
from PyQt6.QtCore import QDateTime, Qt, QTimer, QPoint, QObject, QElapsedTimer, QPointF
...
class SmoothScroll:
    ...
    def __init__(self, widget, orient=Qt.Orientation.Vertical, dynamicEngineEnabled=True):
        """
        Parameters
        ----------
        widget: QScrollArea
