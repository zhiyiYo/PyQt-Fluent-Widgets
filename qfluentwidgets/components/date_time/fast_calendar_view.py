...
from PyQt6.QtCore import Qt, pyqtSignal, QSize, QDate, QCalendar, QLocale
from PyQt6.QtGui import QPainter, QColor
from PyQt6.QtWidgets import QHBoxLayout, QListWidgetItem, QLabel, QWidget, QStackedWidget, QStyle
...
class FastScrollItemDelegate(ScrollItemDelegate):
    ...
    def _drawText(self, painter, option, index):
        ...
        if date == self.currentDate:
            ...
            if not (self.min <= date <= self.max or option.state & QStyle.StateFlag.State_MouseOver) or \
