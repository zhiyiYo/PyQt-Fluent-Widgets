...
class TimePickerBase(PickerBase):
    ...
    def __init__(self, parent=None, showSeconds: bool = False):
        super().__init__(parent=parent)
        self._isSecondVisible: bool = showSeconds
        self._time = QTime()
...
class MinuteFormatter(DigitFormatter):
    """Minute formatter"""
