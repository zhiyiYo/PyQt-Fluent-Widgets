...
如果项目中使用的是 Qt5、PySide2、PySide6 或者 PyQt5，可以在 [Qt5](https://github.com/zhiyiYo/PyQt-Fluent-Widgets/tree/Qt5)、[PySide2](https://github.com/zhiyiYo/PyQt-Fluent-Widgets/tree/PySide2)、[PySide6](https://github.com/zhiyiYo/PyQt-Fluent-Widgets/tree/PySide6) 和 [master](https://github.com/zhiyiYo/PyQt-Fluent-Widgets) 分支下载对应的代码。
