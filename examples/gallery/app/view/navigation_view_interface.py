...
from PySide2.QtWidgets import QWidget, QStackedWidget, QVBoxLayout, QLabel, QHBoxLayout, QFrame, QSizePolicy
...
class NavigationViewInterface(GalleryInterface):
    ...
    def __init__(self, parent=None):
        ...
        self.addExampleCard(
            ...
            widget=breadcrumb,
            sourcePath='https://github.com/zhiyiYo/PyQt-Fluent-Widgets/blob/PySide2/examples/navigation/breadcrumb_bar/demo.py',
            stretch=1
        )
        ...
        self.addExampleCard(
            ...
            sourcePath='https://github.com/zhiyiYo/PyQt-Fluent-Widgets/blob/PySide2/examples/navigation/pivot/demo.py'
        )

        self.addExampleCard(
            title=self.tr('A segmented control'),
            widget=SegmentedInterface(self),
            sourcePath='https://github.com/zhiyiYo/PyQt-Fluent-Widgets/blob/PySide2/examples/navigation/segmented_widget/demo.py'
        )
        ...
        card = self.addExampleCard(
            ...
            sourcePath='https://github.com/zhiyiYo/PyQt-Fluent-Widgets/blob/PySide2/examples/navigation/tab_view/demo.py',
            stretch=1
        )
