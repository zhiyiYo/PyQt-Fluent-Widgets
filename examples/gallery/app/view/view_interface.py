...
from PySide2.QtWidgets import QFrame, QTreeWidgetItem, QHBoxLayout, QTreeWidgetItemIterator, QTableWidgetItem, QListWidgetItem
...
class ViewInterface(GalleryInterface):
    ...
    def __init__(self, parent=None):
        ...
        self.addExampleCard(
            ...
            sourcePath='https://github.com/zhiyiYo/PyQt-Fluent-Widgets/blob/PySide2/examples/view/list_view/demo.py'
        )
        ...
        self.addExampleCard(
            ...
            sourcePath='https://github.com/zhiyiYo/PyQt-Fluent-Widgets/blob/PySide2/examples/view/table_view/demo.py'
        )
        ...
        self.addExampleCard(
            ...
            widget=frame,
            sourcePath='https://github.com/zhiyiYo/PyQt-Fluent-Widgets/blob/PySide2/examples/view/tree_view/demo.py'
        )
        ...
        self.addExampleCard(
            ...
            widget=w,
            sourcePath='https://github.com/zhiyiYo/PyQt-Fluent-Widgets/blob/PySide2/examples/view/flip_view/demo.py'
        )
