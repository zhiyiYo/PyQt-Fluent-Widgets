# coding:utf-8
from PySide2.QtCore import Qt, QEasingCurve
...
class ScrollInterface(GalleryInterface):
    ...
    def __init__(self, parent=None):
        ...
        card = self.addExampleCard(
            ...
            w,
            'https://github.com/zhiyiYo/PyQt-Fluent-Widgets/blob/PySide2/examples/scroll/scroll_area/demo.py',
        )
        ...
        card = self.addExampleCard(
            self.tr('Pips pager'),
            pager,
            'https://github.com/zhiyiYo/PyQt-Fluent-Widgets/blob/PySide2/examples/scroll/pips_pager/demo.py',
        )
