...
class StatusInfoInterface(GalleryInterface):
    ...
    def __init__(self, parent=None):
        ...
        self.addExampleCard(
            ...
            button,
            'https://github.com/zhiyiYo/PyQt-Fluent-Widgets/blob/PySide2/examples/state_tool_tip/demo.py'
        )
        ...
        self.addExampleCard(
            self.tr('State tool tip'),
            button,
            'https://github.com/zhiyiYo/PyQt-Fluent-Widgets/blob/PySide2/examples/tool_tip/demo.py'
        )
        ...
        self.addExampleCard(
            ...
            infoBar,
            'https://github.com/zhiyiYo/PyQt-Fluent-Widgets/blob/PySide2/examples/info_bar/demo.py'
        )
