...
class StatusInfoInterface(GalleryInterface):
    ...
    def __init__(self, parent=None):
        ...
        self.addExampleCard(
            ...
            button,
            'https://github.com/zhiyiYo/PyQt-Fluent-Widgets/blob/PyQt6/examples/status_tool_tip/demo.py'
        )
        ...
        self.addExampleCard(
            ...
            infoBar,
            'https://github.com/zhiyiYo/PyQt-Fluent-Widgets/blob/PyQt6/examples/info_bar/demo.py'
        )
