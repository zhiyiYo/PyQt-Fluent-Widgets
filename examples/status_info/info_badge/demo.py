...
class Demo(QWidget):
    ...
    def __init__(self):
        ...
        self.hBoxLayout1.addWidget(InfoBadge.attention(100))
        ...
        self.hBoxLayout2.addWidget(DotInfoBadge.attention())
        ...
        self.hBoxLayout3.addWidget(IconInfoBadge.attention(FIF.ACCEPT_MEDIUM))
