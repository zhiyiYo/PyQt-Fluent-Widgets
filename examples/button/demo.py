...
class PushButtonDemo(QWidget):
    ...
    def __init__(self):
        ...
        self.gridLayout.addWidget(self.dropDownPushButton1, 5, 0, Qt.AlignmentFlag.AlignLeft)
        self.gridLayout.addWidget(self.dropDownPushButton2, 5, 1, Qt.AlignmentFlag.AlignLeft)
        self.gridLayout.addWidget(self.primaryDropDownPushButton1, 6, 0, Qt.AlignmentFlag.AlignLeft)
        self.gridLayout.addWidget(self.primaryDropDownPushButton2, 6, 1, Qt.AlignmentFlag.AlignLeft)
