...
class Demo(QWidget):
    ...
    def __init__(self):
        ...
        self.vBoxLayout.addWidget(self.splitPushButton, 0, Qt.AlignmentFlag.AlignCenter)
        self.vBoxLayout.addWidget(self.splitToolButton, 0, Qt.AlignmentFlag.AlignCenter)
