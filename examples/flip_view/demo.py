...
from PySide2.QtCore import QModelIndex, Qt, QRect, QSize
from PySide2.QtGui import QIcon, QPainter, QFont, QColor
from PySide2.QtWidgets import QApplication, QStyleOptionViewItem, QWidget, QHBoxLayout, QVBoxLayout
